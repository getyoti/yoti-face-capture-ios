...
private extension FaceCaptureOverlayView {
    ...
    func setUpFaceDetectionView() {
        ...
        NSLayoutConstraint.activate([
            ...
            faceDetectionView.widthAnchor.constraint(equalTo: safeAreaLayoutGuide.widthAnchor,
                                                     multiplier: 0.9),
            faceDetectionView.heightAnchor.constraint(equalTo: safeAreaLayoutGuide.heightAnchor,
                                                      multiplier: 0.65),
            .init(item: faceDetectionView,
                  attribute: .centerY,
                  relatedBy: .equal,
                  toItem: self,
                  attribute: .centerY,
    ...
    func setUpInstructionLabel() {
        ...
        NSLayoutConstraint.activate([
            instructionLabel.widthAnchor.constraint(equalTo: widthAnchor,
                                                    multiplier: 0.5),
            instructionLabel.heightAnchor.constraint(equalTo: heightAnchor,
                                                     multiplier: 0.15),
            instructionLabel.centerXAnchor.constraint(equalTo: centerXAnchor),
            .init(item: instructionLabel,
                  attribute: .centerY,
                  relatedBy: .equal,
                  toItem: self,
                  attribute: .centerY,
